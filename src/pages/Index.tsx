...
const Index = () => {
  const chapters = [
    ...
    { id: "11", title: "Projektledning för Infrastructure as Code-initiativ", area: "Projektledning", status: "completed" },
    { id: "12", title: "Innovation genom infrastrukturtransformation", area: "Innovation", status: "completed" },
    { id: "13", title: "Produktutveckling med Infrastructure as Code-verktyg", area: "Produkt- och tjänstutveckling", status: "completed" },
