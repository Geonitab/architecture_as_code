...
SVENGELSKA_TO_ENGLISH = {
    ...
    r'\butan\b': 'without',
    r'\bmellan\b': 'between',
    r'\butveckling\b': 'development',
    r'\butveckla\b': 'develop',
    r'\butvecklas\b': 'is developed',
    r'\butvecklar\b': 'develops',
    r'\butvecklad\b': 'developed',
    r'\bhantera\b': 'handle',
    r'\bhanterar\b': 'handles',
    r'\bhantering\b': 'handling',
    r'\bhanterad\b': 'handled',
    r'\bmöjliggöra\b': 'enable',
    r'\bmöjliggör\b': 'enables',
    r'\bmöjliggörs\b': 'is enabled',
    r'\bmöjliggort\b': 'enabled',
    r'\bmöjligheter\b': 'possibilities',
    r'\bmöjlighet\b': 'possibility',
    r'\bsäkerställa\b': 'ensure',
    r'\bsäkerställer\b': 'ensures',
    r'\bsäkerställs\b': 'is ensured',
    r'\bsäkerställt\b': 'ensured',
    r'\banvändning\b': 'use',
    r'\banvänder\b': 'uses',
    r'\banvända\b': 'use',
    r'\banvänt\b': 'used',
    r'\banvändare\b': 'user',
    r'\bkunskap\b': 'knowledge',
    r'\bkunskaper\b': 'knowledge',
    r'\bkunna\b': 'be able to',
    r'\bkunde\b': 'could',
    r'\bföljande\b': 'following',
    r'\btidigare\b': 'previous',
    r'\bsenare\b': 'later',
    r'\bförst\b': 'first',
    r'\bsist\b': 'last',
    r'\binnehåll\b': 'content',
    r'\binnehåller\b': 'contains',
    r'\bbeskriver\b': 'describes',
    r'\bbeskriva\b': 'describe',
    r'\bbeskrivet\b': 'described',
    r'\bbeskrivs\b': 'is described',
    r'\bomfattande\b': 'comprehensive',
    r'\bomfatta\b': 'encompass',
    r'\bomfattar\b': 'encompasses',
    r'\bomfattade\b': 'encompassed',
    r'\bgenomförande\b': 'implementation',
    r'\bgenomföra\b': 'implement',
    r'\bgenomför\b': 'implements',
    r'\bgenomfört\b': 'implemented',
    r'\bgenomförs\b': 'is implemented',
    r'\bvilka\b': 'which',
    r'\bvilken\b': 'which',
    r'\bvilket\b': 'which',
    r'\bvars\b': 'whose',
    ...
    r'\bmycket\b': 'very',
    r'\beftom\b': 'since',
    r'\bdarför\b': 'therefore',
    r'\benligt\b': 'according to',
    r'\binom\b': 'within',
    r'\butanför\b': 'outside',
    r'\bovanför\b': 'above',
    r'\bnedanför\b': 'below',
    r'\bpå\b': 'on',
    r'\bav\b': 'of',
