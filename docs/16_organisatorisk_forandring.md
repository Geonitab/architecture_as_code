...
team_structure:
  ...
  roles:
    ...
    - role: "Senior Infrastructure Engineer"
      count: 2
      responsibilities:
        - "Architecture as Code development"
...
class IaCCompetencyFramework:
    """
    Comprehensive competency framework for Architecture as Code skills
    """
