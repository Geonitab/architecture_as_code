...
2. **Expand and federate:** Onboard additional teams, using the blueprint’s competency frameworks and mentoring patterns to build confidence outside the initial cohort.【F:docs/17_organizational_change.md】【F:docs/30_appendix_code_examples.md】
