# FINOS Project Blueprint: Operationalising Architecture as Code {#appendix-finos-project-blueprint}
...
2. **Expand and federate:** Onboard additional teams, using the blueprint’s competency frameworks and mentoring patterns to build confidence outside the initial cohort.【F:docs/17_organisational_change.md】【F:docs/30_appendix_code_examples.md】
...
4. **Sustain and innovate:** Allocate explicit time for experimentation, conference participation, and continuous learning so that the platform evolves alongside business ambitions.【F:docs/30_appendix_code_examples.md】【F:docs/17_organisational_change.md】
