...
Security and compliance practices from [Security Fundamentals](09_security_fundamentals.md), [Advanced Security Patterns](09_security_patterns.md), and [Policy and Security as Code](10_policy_and_security.md) also need to be embedded so that codified architecture does not introduce blind spots.
