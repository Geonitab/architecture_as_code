...
This chapter presenterar the personer and organisationer as bidragit to createndet of "Architecture as Code" - a comprehensive guide for praktisk application of Architecture as Code in organizations.
...
**Kodarkitektur Bokverkstad** is The huvudsakliga redaktionella kraften behind This publikation. Organisationen represents a samling of experter within architecture, infrastructure and system development as arbetat tosammans to create a heltäckande resurs for organizations.
...
**Background:**
Bokverkstaden grundades with målet to överbrygga klyftan between teoretiska arkitekturprinciper and praktisk Architecture as Code-implementation in organizations. by kombinera akademisk rigorositet with verklig branschexpertis has teamet created a resurs as talar direkt to IT-organisationers behov.

## Bidragande experter

### Infrastrukturspecialister

**DevOps-community** has bidragit with comprehensive praktisk knowledge about implementation of Architecture as Code in environments. This grupp includes:

- **Molnarkitekter** from ledande teknologiforetag
- **DevOps Engineers** with specialistkunskap within automation
- **Säkerhetsexperter** with fokus at compliance-requirements
...
- validation of terminologi and språkbruk
- testing of build-processes and distribution

### organizations

Flera organizations has bidragit with:

- **Fallstudier** from verkliga Architecture as Code-implementations
- **Architecture as Code best practices** from molnmigreringar
- **Compliance-vägledning** for regelverk
- **Säkerhetsperspektiv** from cybersäkerhetsexperter
...
Vi välkomnar bidrag from technical community:
...
"Architecture as Code" represents A kollektivt arbete from experter within architecture, infrastructure and system development. by kombinera teoretisk grund with praktisk expertis has This team created a resurs as specific meets svenska organisationers behov within Architecture as Code and Architecture as Code.
